...
def observation__orbit(
    ...
    tangent altitudes. Solar angles are calculated from the satellite position. The observation is
    ...
    try:
        ...
        logging.error('The skplatform package is not installed. skplatform must be installed to use orbit simulations.')
        raise
